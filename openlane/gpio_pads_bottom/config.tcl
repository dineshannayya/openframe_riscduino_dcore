...
# Name
set ::env(DESIGN_NAME) gpio_pads_bottom
...
set ::env(VERILOG_FILES) "\
        $::env(DESIGN_DIR)/../../verilog/rtl/gpio_pads/src/gpio_pads_bottom.sv \
        $::env(DESIGN_DIR)/../../verilog/rtl/gpio_pads/src/gpio_control_block.v \
	"

set ::env(SYNTH_DEFINES) [list SYNTHESIS ]

set ::env(SYNTH_PARAMETERS) "OPENFRAME_IO_PADS=6  "
